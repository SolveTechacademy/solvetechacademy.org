...
<head>
    <meta charset="utf-8">
    <title>SolveTech : Online About Us</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <p class="m-0 fw-bold" style="font-size: 25px;"><img src="img/solvetechacademy.png" alt="" height="50px"><span style="color: #fb873f;"></span></p>
        </a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">
                        At SolveTech, we believe in accessible, innovative learning experiences that adapt to your
                    ...
                    <p class="mb-4">Welcome to SolveTech Academy, where learning knows no boundaries. Our mission
                        is to empower individuals worldwide through accessible and innovative education. Here's what
                        sets us apart:</p>

                    <h3 class="mb-4">Our Vision</h3>
                    <p class="mb-4">At SolveTech, we envision a world where learning is accessible to everyone,
                    ...
                    <p class="mb-4">We believe in the transformative power of education. SolveTech is
                    ...
                    <p class="mb-4"> SolveTech is more than just courses; it's a vibrant community. We
                    ...
                    <p class=" mt-5 mb-4">Thank you! for being a part of SolveTech. Together, let's embark on a
